        ...
        Label        -compare-1-sub            
        Exchange                               
        JumpTrue     -compare-1-arg1true       
        JumpTrue     -compare-1-true           
        PushI        0                         
        Jump         -compare-1-join           
        Label        -compare-1-arg1true       
        Pop                                    
        ...
        Label        -compare-4-sub            
        Exchange                               
        JumpTrue     -compare-4-arg1true       
        JumpTrue     -compare-4-true           
        PushI        0                         
        Jump         -compare-4-join           
        Label        -compare-4-arg1true       
        Pop                                    
        ...
        Label        -compare-7-sub            
        Exchange                               
        JumpTrue     -compare-7-arg1true       
        JumpTrue     -compare-7-true           
        PushI        0                         
        Jump         -compare-7-join           
        Label        -compare-7-arg1true       
        Pop                                    
        ...
        Exchange                               
        JumpTrue     -compare-10-arg1true      
        JumpTrue     -compare-10-true          
        PushI        0                         
        Jump         -compare-10-join          
        Label        -compare-10-arg1true      
        Pop                                    
        ...
        Exchange                               
        JumpTrue     -compare-13-arg1true      
        JumpTrue     -compare-13-true          
        PushI        0                         
        Jump         -compare-13-join          
        Label        -compare-13-arg1true      
        Pop                                    
        ...
        Exchange                               
        JumpTrue     -compare-16-arg1true      
        JumpTrue     -compare-16-true          
        PushI        0                         
        Jump         -compare-16-join          
        Label        -compare-16-arg1true      
        Pop                                    
        ...
        Exchange                               
        JumpTrue     -compare-19-arg1true      
        JumpTrue     -compare-19-true          
        PushI        0                         
        Jump         -compare-19-join          
        Label        -compare-19-arg1true      
        Pop                                    
        ...
        Exchange                               
        JumpTrue     -compare-22-arg1true      
        JumpTrue     -compare-22-true          
        PushI        0                         
        Jump         -compare-22-join          
        Label        -compare-22-arg1true      
        Pop                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -print-value-25-end       
        Label        -print-value-25-char      
        PushD        $print-value-typeid       
        LoadI                                  
        JumpTrue     -print-value-25-int       
        PushD        $print-value-address      
        LoadI                                  
        LoadC                                  
        PushD        $print-format-char        
        Printf                                 
        Label        -print-value-25-int       
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        1                         
        Subtract                               
        JumpTrue     -print-value-25-float     
        PushD        $print-value-address      
        LoadI                                  
        LoadI                                  
        PushD        $print-format-integer     
        Printf                                 
        Label        -print-value-25-float     
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        2                         
        Subtract                               
        JumpTrue     -print-value-25-string    
        PushD        $print-value-address      
        LoadI                                  
        LoadF                                  
        PushD        $print-format-floating    
        Printf                                 
        Label        -print-value-25-string    
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        3                         
        Subtract                               
        JumpTrue     -print-value-25-bool      
        PushD        $print-value-address      
        LoadI                                  
        LoadI                                  
        PushI        12                        
        ...
        Printf                                 
        Label        -print-value-25-bool      
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        4                         
        Subtract                               
        JumpTrue     -print-value-25-end       
        PushD        $print-value-address      
        LoadI                                  
        LoadC                                  
        JumpTrue     -print-value-25-true      
        PushD        $boolean-false-string     
        Jump         -print-value-25-pastTrue  
        Label        -print-value-25-true      
        PushD        $boolean-true-string      
        Label        -print-value-25-pastTrue  
        PushD        $print-format-string      
        Printf                                 
        Label        -print-value-25-end       
        PushD        $print-value-return-address 
        LoadI                                  
        Return                                 
        Label        $print-range              
        DLabel       -print-range-26-return-address 
        DataZ        4                         
        DLabel       -print-range-26-typeID    
        DataZ        4                         
        DLabel       -print-range-26-address   
        DataZ        4                         
        PushD        -print-range-26-return-address 
        Exchange                               
        StoreI                                 
        PushI        7                         
        BTAnd                                  
        PushD        -print-range-26-typeID    
        Exchange                               
        StoreI                                 
        PushD        -print-range-26-address   
        Exchange                               
        StoreI                                 
        ...
        PushD        -print-range-26-typeID    
        LoadI                                  
        JumpTrue     -print-range-26-type-int  
        PushI        1                         
        Jump         -print-range-26-after-offset 
        Label        -print-range-26-type-int  
        PushD        -print-range-26-typeID    
        LoadI                                  
        PushI        1                         
        BTAnd                                  
        JumpFalse    -print-range-26-type-float 
        PushI        4                         
        Jump         -print-range-26-after-offset 
        Label        -print-range-26-type-float 
        PushD        -print-range-26-typeID    
        LoadI                                  
        PushI        2                         
        BTAnd                                  
        ...
        PushI        8                         
        Label        -print-range-26-after-offset 
        PushD        -print-range-26-address   
        LoadI                                  
        Add                                    
        PushD        -print-range-26-typeID    
