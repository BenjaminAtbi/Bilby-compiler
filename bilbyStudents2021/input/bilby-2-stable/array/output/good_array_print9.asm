        ...
        Return                                 
        Label        $print-range              
        DLabel       -print-range-10-return-address 
        DataZ        4                         
        DLabel       -print-range-10-typeID    
        DataZ        4                         
        DLabel       -print-range-10-address   
        DataZ        4                         
        PushD        -print-range-10-return-address 
        Exchange                               
        StoreI                                 
        PushI        7                         
        BTAnd                                  
        PushD        -print-range-10-typeID    
        Exchange                               
        StoreI                                 
        PushD        -print-range-10-address   
        Exchange                               
        StoreI                                 
        ...
        PushD        -print-range-10-typeID    
        LoadI                                  
        JumpTrue     -print-range-10-type-int  
        PushI        1                         
        Jump         -print-range-10-after-offset 
        Label        -print-range-10-type-int  
        PushD        -print-range-10-typeID    
        LoadI                                  
        PushI        1                         
        BTAnd                                  
        JumpFalse    -print-range-10-type-float 
        PushI        4                         
        Jump         -print-range-10-after-offset 
        Label        -print-range-10-type-float 
        PushD        -print-range-10-typeID    
        LoadI                                  
        PushI        2                         
        BTAnd                                  
        ...
        PushI        8                         
        Label        -print-range-10-after-offset 
        PushD        -print-range-10-address   
        LoadI                                  
        Add                                    
        PushD        -print-range-10-typeID    
