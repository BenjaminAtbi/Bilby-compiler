        ...
        StoreI                                 
        Subtract                               
        JumpPos      -access-array-6-noError   
        Jump         $$array-out-of-bounds     
        Label        -access-array-6-noError   
        PushD        $reference-space-2        
        LoadI                                  
        JumpNeg      $$array-out-of-bounds     
        PushD        $reference-space-1        
        ...
        StoreI                                 
        Subtract                               
        JumpPos      -access-array-37-noError  
        Jump         $$array-out-of-bounds     
        Label        -access-array-37-noError  
        PushD        $reference-space-2        
        LoadI                                  
        JumpNeg      $$array-out-of-bounds     
        PushD        $reference-space-1        
        ...
        StoreI                                 
        Subtract                               
        JumpPos      -access-array-40-noError  
        Jump         $$array-out-of-bounds     
        Label        -access-array-40-noError  
        PushD        $reference-space-2        
        LoadI                                  
        JumpNeg      $$array-out-of-bounds     
        PushD        $reference-space-1        
        ...
        StoreI                                 
        Subtract                               
        JumpPos      -access-array-43-noError  
        Jump         $$array-out-of-bounds     
        Label        -access-array-43-noError  
        PushD        $reference-space-2        
        LoadI                                  
        JumpNeg      $$array-out-of-bounds     
        PushD        $reference-space-1        
        ...
        Exchange                               
        StoreI                                 
        Jump         -print-value-44-end       
        Label        -print-value-44-char      
        PushD        $print-value-typeid       
        LoadI                                  
        JumpTrue     -print-value-44-int       
        PushD        $print-value-address      
        LoadI                                  
        LoadC                                  
        PushD        $print-format-char        
        Printf                                 
        Label        -print-value-44-int       
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        1                         
        Subtract                               
        JumpTrue     -print-value-44-float     
        PushD        $print-value-address      
        LoadI                                  
        LoadI                                  
        PushD        $print-format-integer     
        Printf                                 
        Label        -print-value-44-float     
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        2                         
        Subtract                               
        JumpTrue     -print-value-44-string    
        PushD        $print-value-address      
        LoadI                                  
        LoadF                                  
        PushD        $print-format-floating    
        Printf                                 
        Label        -print-value-44-string    
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        3                         
        Subtract                               
        JumpTrue     -print-value-44-bool      
        PushD        $print-value-address      
        LoadI                                  
        LoadI                                  
        PushI        12                        
        ...
        Printf                                 
        Label        -print-value-44-bool      
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        4                         
        Subtract                               
        JumpTrue     -print-value-44-end       
        PushD        $print-value-address      
        LoadI                                  
        LoadC                                  
        JumpTrue     -print-value-44-true      
        PushD        $boolean-false-string     
        Jump         -print-value-44-pastTrue  
        Label        -print-value-44-true      
        PushD        $boolean-true-string      
        Label        -print-value-44-pastTrue  
        PushD        $print-format-string      
        Printf                                 
        Label        -print-value-44-end       
        PushD        $print-value-return-address 
        LoadI                                  
        Return                                 
        Label        $print-range              
        DLabel       -print-range-45-return-address 
        DataZ        4                         
        DLabel       -print-range-45-typeID    
        DataZ        4                         
        DLabel       -print-range-45-address   
        DataZ        4                         
        PushD        -print-range-45-return-address 
        Exchange                               
        StoreI                                 
        PushI        7                         
        BTAnd                                  
        PushD        -print-range-45-typeID    
        Exchange                               
        StoreI                                 
        PushD        -print-range-45-address   
        Exchange                               
        StoreI                                 
        ...
        PushD        -print-range-45-typeID    
        LoadI                                  
        JumpTrue     -print-range-45-type-int  
        PushI        1                         
        Jump         -print-range-45-after-offset 
        Label        -print-range-45-type-int  
        PushD        -print-range-45-typeID    
        LoadI                                  
        PushI        1                         
        BTAnd                                  
        JumpFalse    -print-range-45-type-float 
        PushI        4                         
        Jump         -print-range-45-after-offset 
        Label        -print-range-45-type-float 
        PushD        -print-range-45-typeID    
        LoadI                                  
        PushI        2                         
        BTAnd                                  
        ...
        PushI        8                         
        Label        -print-range-45-after-offset 
        PushD        -print-range-45-address   
        LoadI                                  
        Add                                    
        PushD        -print-range-45-typeID    
