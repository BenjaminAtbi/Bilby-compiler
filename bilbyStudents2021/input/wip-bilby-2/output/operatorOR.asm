        ...
        Label        -compare-3-sub            
        Exchange                               
        JumpTrue     -compare-3-arg1true       
        JumpTrue     -compare-3-true           
        PushI        0                         
        Jump         -compare-3-join           
        Label        -compare-3-arg1true       
        Pop                                    
        ...
        Label        -compare-9-sub            
        Exchange                               
        JumpTrue     -compare-9-arg1true       
        JumpTrue     -compare-9-true           
        PushI        0                         
        Jump         -compare-9-join           
        Label        -compare-9-arg1true       
        Pop                                    
        ...
        Exchange                               
        JumpTrue     -compare-12-arg1true      
        JumpTrue     -compare-12-true          
        PushI        0                         
        Jump         -compare-12-join          
        Label        -compare-12-arg1true      
        Pop                                    
        ...
        Exchange                               
        JumpTrue     -compare-15-arg1true      
        JumpTrue     -compare-15-true          
        PushI        0                         
        Jump         -compare-15-join          
        Label        -compare-15-arg1true      
        Pop                                    
        ...
        Exchange                               
        JumpTrue     -compare-18-arg1true      
        JumpTrue     -compare-18-true          
        PushI        0                         
        Jump         -compare-18-join          
        Label        -compare-18-arg1true      
        Pop                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -print-value-21-end       
        Label        -print-value-21-char      
        PushD        $print-value-typeid       
        LoadI                                  
        JumpTrue     -print-value-21-int       
        PushD        $print-value-address      
        LoadI                                  
        LoadC                                  
        PushD        $print-format-char        
        Printf                                 
        Label        -print-value-21-int       
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        1                         
        Subtract                               
        JumpTrue     -print-value-21-float     
        PushD        $print-value-address      
        LoadI                                  
        LoadI                                  
        PushD        $print-format-integer     
        Printf                                 
        Label        -print-value-21-float     
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        2                         
        Subtract                               
        JumpTrue     -print-value-21-string    
        PushD        $print-value-address      
        LoadI                                  
        LoadF                                  
        PushD        $print-format-floating    
        Printf                                 
        Label        -print-value-21-string    
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        3                         
        Subtract                               
        JumpTrue     -print-value-21-bool      
        PushD        $print-value-address      
        LoadI                                  
        LoadI                                  
        PushI        12                        
        ...
        Printf                                 
        Label        -print-value-21-bool      
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        4                         
        Subtract                               
        JumpTrue     -print-value-21-end       
        PushD        $print-value-address      
        LoadI                                  
        LoadC                                  
        JumpTrue     -print-value-21-true      
        PushD        $boolean-false-string     
        Jump         -print-value-21-pastTrue  
        Label        -print-value-21-true      
        PushD        $boolean-true-string      
        Label        -print-value-21-pastTrue  
        PushD        $print-format-string      
        Printf                                 
        Label        -print-value-21-end       
        PushD        $print-value-return-address 
        LoadI                                  
        Return                                 
        Label        $print-range              
        DLabel       -print-range-22-return-address 
        DataZ        4                         
        DLabel       -print-range-22-typeID    
        DataZ        4                         
        DLabel       -print-range-22-address   
        DataZ        4                         
        PushD        -print-range-22-return-address 
        Exchange                               
        StoreI                                 
        PushI        7                         
        BTAnd                                  
        PushD        -print-range-22-typeID    
        Exchange                               
        StoreI                                 
        PushD        -print-range-22-address   
        Exchange                               
        StoreI                                 
        ...
        PushD        -print-range-22-typeID    
        LoadI                                  
        JumpTrue     -print-range-22-type-int  
        PushI        1                         
        Jump         -print-range-22-after-offset 
        Label        -print-range-22-type-int  
        PushD        -print-range-22-typeID    
        LoadI                                  
        PushI        1                         
        BTAnd                                  
        JumpFalse    -print-range-22-type-float 
        PushI        4                         
        Jump         -print-range-22-after-offset 
        Label        -print-range-22-type-float 
        PushD        -print-range-22-typeID    
        LoadI                                  
        PushI        2                         
        BTAnd                                  
        ...
        PushI        8                         
        Label        -print-range-22-after-offset 
        PushD        -print-range-22-address   
        LoadI                                  
        Add                                    
        PushD        -print-range-22-typeID    
