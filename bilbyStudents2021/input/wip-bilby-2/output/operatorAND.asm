        ...
        JumpFalse    -compare-18-false         
        PushI        1                         
        Jump         -compare-18-join          
        Label        -compare-18-arg1false     
        Pop                                    
