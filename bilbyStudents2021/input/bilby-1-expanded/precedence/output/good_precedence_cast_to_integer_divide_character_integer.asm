        ...
        Exchange                               
        StoreI                                 
        Jump         -print-value-37-end       
        Label        -print-value-37-char      
        PushD        $print-value-typeid       
        LoadI                                  
        JumpTrue     -print-value-37-int       
        PushD        $print-value-address      
        LoadI                                  
        LoadC                                  
        PushD        $print-format-char        
        Printf                                 
        Label        -print-value-37-int       
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        1                         
        Subtract                               
        JumpTrue     -print-value-37-float     
        PushD        $print-value-address      
        LoadI                                  
        LoadI                                  
        PushD        $print-format-integer     
        Printf                                 
        Label        -print-value-37-float     
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        2                         
        Subtract                               
        JumpTrue     -print-value-37-string    
        PushD        $print-value-address      
        LoadI                                  
        LoadF                                  
        PushD        $print-format-floating    
        Printf                                 
        Label        -print-value-37-string    
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        3                         
        Subtract                               
        JumpTrue     -print-value-37-bool      
        PushD        $print-value-address      
        LoadI                                  
        LoadI                                  
        PushI        12                        
        ...
        Printf                                 
        Label        -print-value-37-bool      
        PushD        $print-value-typeid       
        LoadI                                  
        PushI        4                         
        Subtract                               
        JumpTrue     -print-value-37-end       
        PushD        $print-value-address      
        LoadI                                  
        LoadC                                  
        JumpTrue     -print-value-37-true      
        PushD        $boolean-false-string     
        Jump         -print-value-37-pastTrue  
        Label        -print-value-37-true      
        PushD        $boolean-true-string      
        Label        -print-value-37-pastTrue  
        PushD        $print-format-string      
        Printf                                 
        Label        -print-value-37-end       
        PushD        $print-value-return-address 
        LoadI                                  
        Return                                 
        Label        $print-range              
        DLabel       -print-range-38-return-address 
        DataZ        4                         
        DLabel       -print-range-38-typeID    
        DataZ        4                         
        DLabel       -print-range-38-address   
        DataZ        4                         
        PushD        -print-range-38-return-address 
        Exchange                               
        StoreI                                 
        PushI        7                         
        BTAnd                                  
        PushD        -print-range-38-typeID    
        Exchange                               
        StoreI                                 
        PushD        -print-range-38-address   
        Exchange                               
        StoreI                                 
        ...
        PushD        -print-range-38-typeID    
        LoadI                                  
        JumpTrue     -print-range-38-type-int  
        PushI        1                         
        Jump         -print-range-38-after-offset 
        Label        -print-range-38-type-int  
        PushD        -print-range-38-typeID    
        LoadI                                  
        PushI        1                         
        BTAnd                                  
        JumpFalse    -print-range-38-type-float 
        PushI        4                         
        Jump         -print-range-38-after-offset 
        Label        -print-range-38-type-float 
        PushD        -print-range-38-typeID    
        LoadI                                  
        PushI        2                         
        BTAnd                                  
        ...
        PushI        8                         
        Label        -print-range-38-after-offset 
        PushD        -print-range-38-address   
        LoadI                                  
        Add                                    
        PushD        -print-range-38-typeID    
